	...
	<form name="data" action="join_p.jsp" method="post" onsubmit="return checkValue()">
		<table class="table_line">
			...
			<tr>
				<th>고객등급</th>
				<td>
					<input type="radio" name="grade">A-VIP
					<input type="radio" name="grade">B-일반
					<input type="radio" name="grade" checked>C-직원
				</td>
			</tr>
			<tr>
				<th>도시코드</th>
				<td>
					<select name="city">
						<option value="" disabled selected hidden>도시 선택</option>
